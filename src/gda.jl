...
"""
**Gaussian discriminant analysis.** Provide a `gda_func` of either `qda_soft`, `qda_hard`, `lda_soft`, or `lda_hard`.
...
function qda_soft(μ₀, Σ₀, π₀, μ₁, Σ₁, π₁)
    δ = x -> (x - μ₀)'inv(Σ₀)*(x - μ₀) + log(det(Σ₀)) -
	         log(π₀) - (x - μ₁)'inv(Σ₁)*(x - μ₁) - log(det(Σ₁)) + log(π₁)
    return δ
end
...
_USING_NOTEBOOK && TableOfContents()

# ╔═╡ 07b0385b-b065-4e16-ba93-ee34457044c5
_USING_NOTEBOOK && gdaplot(𝒟)

# ╔═╡ 1f09ea5c-5c57-435f-885f-2a4882782d51
_USING_NOTEBOOK && gdaplot(𝒟, use_qda=false)

# ╔═╡ 219be453-b6e6-4150-a8f9-41a4f3d42951
_USING_NOTEBOOK && gdaplot(𝒟, use_qda=false, soft=false)

# ╔═╡ bf7a2a72-8a17-4301-af80-9a2f0d8dff31
_USING_NOTEBOOK && gdaplot(𝒟)

# ╔═╡ a74a168a-0147-4dea-9a9e-c0bb2762b73f
_USING_NOTEBOOK && gdaplot(𝒟, soft=false)

# ╔═╡ 5307cc37-61dd-4eb7-a3b2-29ca009d37b5
_USING_NOTEBOOK && gdaplot(𝒟, show_svm=true)
